...
class OTPVerificationScreen extends StatefulWidget {
  final String userId;
  final String email;
  OTPVerificationScreen({required this.userId, required this.email});
...
class _OTPVerificationScreenState extends State<OTPVerificationScreen> {
  ...
  Future<void> _sendOtp() async {
    ...
    try {
      ...
      final otp = (100000 + (999999 - 100000) * (new DateTime.now().millisecondsSinceEpoch % 1000) ~/ 1000).toString();
      ...
      setState(() { _sentMessage = 'Error: ' + e.toString(); });
    } finally {
